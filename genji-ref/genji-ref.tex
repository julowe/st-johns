...
\begin{multicols}{2}
	...
	%\vspace*{-0.4cm}
	% normal size font gts us to 2 pages plus 9 lines...  with 0.25em itemsep
	\begin{small}% this gets us to 1 page with 0.15em itemsep
	%\begin{footnotesize}% this only gets us to 2.25 pages, use above
	% TODO: don't unindent items, but increase margins and indent following lines
	\begin{itemize}[
			label=,
			leftmargin=0em,
			rightmargin=-1.5em,
...
\begin{multicols}{3}
	%\vspace*{-0.4cm}
	% normal size font gets us to 
	%\begin{small}% this gets us to 2.5 pages with 2 columns. maybe just over 2.5 pages with 3 columns. could try diff indenting but ugh.
	\begin{footnotesize}% this gets us to 2 pages with 3 columns and 4em colsep
	\begin{itemize}[
			label=,
			leftmargin=0em,
			rightmargin=-1.5em,
...
\begin{multicols}{2}
	...
	%\vspace*{-0.4cm}
	% normal size font gts us to ... pages
	\begin{small}% this gets us to 4 pages
